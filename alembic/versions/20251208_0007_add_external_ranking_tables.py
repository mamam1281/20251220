...
def upgrade() -> None:
    if not _table_exists("external_ranking_data"):
        op.create_table(
    ...
    if not _table_exists("external_ranking_reward_log"):
        op.create_table(
...
def downgrade() -> None:
    if _table_exists("external_ranking_reward_log"):
        op.drop_table("external_ranking_reward_log")
    if _table_exists("external_ranking_data"):
